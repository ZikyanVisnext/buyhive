...
<div class="footer-parent">
    ...
    <div class="footer-col-right-generic">
        ...
        <div class="footer-col-4">
            <p class="footer-col2-about-text">Account</p>
            <ul class="footer-col2-about" v-for="item in account">
                <li>{{ item }}</li>
            </ul>
        </div>
        ...
        <div class="footer-col-5">
            <p class="footer-col2-about-text">Our Locations</p>
            <ul class="footer-col2-about" v-for="item in ourLocations">
                <li>{{ item }}</li>
            </ul>
        </div>
    </div>
    ...
    <div class="payment-card-images">
        ...
        <img class="ach-image" src="../assets/ach.png" alt="">
    </div>
    ...
    <div class="footer-bottom-bar-container">
        <div class="footer-bottom-bar-left">
            <p>© 2023 BuyHive Limited All Rights Reserved</p>
        </div>
...
export default{
    data(){
        return {
            aboutUs:['Our Story', 'How to Buy', 'Our Partners', 'Contact Us',
            'Careers', 'Terms of Use', 'Privacy Policy'],
            ourServices:['Expert Sourcing', 'Contract Manufacturing', 'Buy',
            'Financing'],
            account:['Sign In', 'Register to Buy', 'My Profile', 'My Orders',
            'Register to Sell', 'Become a Sourcing Expert'],
            ourLocations:['BuyHive Limited', 'Dragon Industrial Bldg. Unit 8B, 93 King Lam St. Cheung Sha Wan, Kowloon, Hong Kong',
            'BuyHive USA Inc.', '4730 South Fort Apache Rd. Suite 300 Las Vegas, NV 89147 USA']
        }
    }
}
</script>
...
.footer-col-left-generic{
    flex: 2;
}
.footer-col-right-generic{
    flex: 4;
    /* background-color: crimson; */
}
...
.footer-col2-about-text{
    font-size: 20px;
    font-weight: 500;
}
.footer-col2-about li{
    font-size: 17px;
    margin: 15px 0;
    color: #8B8889;
    cursor: pointer;
